...
/**
 * Mesma ferramenta de compartilhar da página pública do imóvel (site), para
 * usar dentro do painel — mesmo link e mesma mensagem. Sem tracking: aqui quem
 * compartilha é o corretor, não um visitante do site.
 */
...
export function CompartilharImovelButton({ codigo, titulo }: Props) {
  ...
  return (
    <div ref={wrapRef} className="relative inline-block">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 transition"
      >
